...
export const fromIncidentRow = (row) => {
  ...
  const {
    ...
    nh_on_scene, ripv_on_scene, other_on_scene, other_on_scene_details,
    time_of_arrival, marker_post, vehicle_type, location,
    time_completed, vehicle_reg_no, vehicle_make_model,
    transmission, no_of_passengers, speedo,
    actual_fault, checks, vehicle_condition,
    recovery_destination, vehicle_in_storage,
    storage_email, property_removed, vehicle_outcome, service_acceptance,
    name, customer_contact_no, customer_address,
    satisfaction_confirmed, send_report_copy, signature_url, time_spotted_to_on,
  ...
  return {
    ...
    otherOnScene: other_on_scene, otherOnSceneDetails: other_on_scene_details,
    timeOfArrival: time_of_arrival, markerPost: marker_post,
    vehicleType: vehicle_type, location,
    ...
    name, customerContactNo: customer_contact_no,
    customerAddress: customer_address,
    satisfactionConfirmed: satisfaction_confirmed,
    sendReportCopy: send_report_copy,
...
export const toIncidentRow = (formData) => {
  const map = {
    ...
    ripvOnScene: "ripv_on_scene", otherOnScene: "other_on_scene",
    otherOnSceneDetails: "other_on_scene_details",
    ...
    storageEmail: "storage_email", propertyRemoved: "property_removed",
    vehicleOutcome: "vehicle_outcome", serviceAcceptance: "service_acceptance",
    name: "name", customerContactNo: "customer_contact_no",
    customerAddress: "customer_address",
    satisfactionConfirmed: "satisfaction_confirmed",
    sendReportCopy: "send_report_copy",
    signatureUrl: "signature_url", timeSpottedToOn: "time_spotted_to_on",
